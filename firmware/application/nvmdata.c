...
DECLARE_NVM_DATA(SCAN_DPI_200_CALIBDATA_COLOR_DARK_A);
DECLARE_NVM_DATA(SCAN_DPI_200_CALIBDATA_COLOR_DARK_B);
...
DECLARE_NVM_DATA(SCAN_DPI_200_CALIBDATA_COLOR_A);
DECLARE_NVM_DATA(SCAN_DPI_200_CALIBDATA_COLOR_B);
...
static nvram_block_t eeprom_blocks[]=
{
	...
	NVM_DATA_ENTRY(SCAN_DPI_200_ADC_B),
	NVM_DATA_ENTRY(SCAN_DPI_200_CIS_A),
	NVM_DATA_ENTRY(SCAN_DPI_200_CIS_B),
};
...
{
	NVM_DATA_ENTRY(SCAN_DPI_200_CALIBDATA_COLOR_DARK_A),
	NVM_DATA_ENTRY(SCAN_DPI_200_CALIBDATA_COLOR_DARK_B),
	NVM_DATA_ENTRY(SCAN_DPI_200_CALIBDATA_COLOR_A),
	NVM_DATA_ENTRY(SCAN_DPI_200_CALIBDATA_COLOR_B),
};
